...
public class AndroidTagViewActivity extends AppCompatActivity {
...
//                mTagContainerLayout1.removeTag(position);
                Toast.makeText(AndroidTagViewActivity.this, "Click TagView cross! position = " + position,
                        Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mTagContainerLayout3.setOnTagClickListener(new TagView.OnTagClickListener() {
            ...
            public void onTagLongClick(final int position, String text) {
                ...
                List<Integer> selectedPositions = mTagContainerLayout3.getSelectedTagViewPositions();
                Toast.makeText(AndroidTagViewActivity.this, "selected-positions:" + selectedPositions.toString(),
                        Toast.LENGTH_SHORT).show();
            }
